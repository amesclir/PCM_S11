...
Para visualizar el modelo biogeográfico DEC vamos usar los data set del grupo de hormigas cultivadoras de hongos de la Tribu Attini de Branstetter et al. 2017.
...
Podemos crear por tanto este objeto directamente con todos los parámetros y argumentos que queremos que tenga con define_BioGeoBEARS_run. Si no modificamos nada, tendremos el modelo DEC.
